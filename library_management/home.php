...
if(isset($_SESSION['UNAME']))
{
  ...
  $q1="SELECT * from uregistration where name='$uname1'";
...
{ 
  if(isset($_POST['username']) and isset($_POST['upassword']))
  {
    ...
    $q2="SELECT * from uregistration where name='$uname1' AND upassword='$upassword1'";
    ...
    {  
        ...
        $q3="SELECT * from uregistration where name='$uname2'";
   ...
   <div class="card-deck justify-content-center text-center">
    <div class="col-sm-5 card text-center bg-light text-success">
       <div class="card-header">
        ...
        <div class="card-body">
           <a href="insertForm.php" target="_blank" style="color: green;"> Insert Record<a/><br/><br/><br/>
           <a href="viewForm.php" target="_blank" style="color: green;"> View Record<a/><br/><br/><br/>
           <a href="deleteForm.php" target="_blank" style="color: green;"> Delete Record<a/><br/><br/><br/>
           <a href="updateForm.php" target="_blank" style="color: green;"> Update Record<a/><br/>
        </div>
