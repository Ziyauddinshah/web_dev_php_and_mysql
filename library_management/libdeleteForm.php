...
if(isset($_POST['delete']))
{
  ...
  else
  {
        ...
        echo "<script> alert('Only Authorised can delete...') </script>";
  ...
  <div class="card-deck justify-content-center">
    <div class="col-sm-10 text-align bg-light">
       <?php
        ...
        if($size)
        {
          echo $size." <text style='color:green'> Record Deleted Successfully...</text>";
           ...
           else
           {
              ...
              // echo '<script>alert("Only Authorised can delete")</script>';
              echo "<text style='color:red'>Deletion failed..</text>";
...
<div class="container">
   <h1 style="color:black;text-align:center;"> Library Record Management </h1>
    <br>
  <div class="card-deck justify-content-center">
    <div class="col-sm-10 ">
      <form action="libdeleteForm.php" method="post">
          <table class="table" >
             <thead >
                <th>  Id </th>
                <th> Student Name </th>
           ...
           ?>
            <tfoot>
               <td style="text-align:center;" colspan="100"> <input type="submit" name="delete" value="Delete" /></td>
            </tfoot>
          </table> 
      </form>
    </div>
