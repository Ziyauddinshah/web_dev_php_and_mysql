...
<html>
 ...
 <!-- <iframe width="560" height="315" src="https://mdbootstrap.com/api/snippets/embed/2445225/fullscreen" frameborder="0"></iframe> -->
 </head>
 <body >
<nav class="navbar navbar-expand-md navbar-light bg-info fixed-top" >
    ...
    <div class="collapse navbar-collapse justify-content-between" id="nav">
      <ul class="navbar-nav" >
        ...
        <li class="nav-item">
          <a class="nav-link text-light font-weight-bold px-3" href="givebook.php">Book Allotement</a>
        </li>  
        <li class="nav-item dropdown" data-toggle="dropdown" data-hover="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="givebook.php">Book Allotement</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" style="height: 500px;">
        ...
        <div class="modal-body" >
          <form  action="libhome.php" method="post" >
              <div class="table">
...
$(document).ready(function(){
 ...
 <div class="container">
   <div class="card-deck justify-content-center text-center">
    <div class="col-sm-5 card text-center bg-light text-success">
       <div class="card-header">
            <h1> Library Record Management </h1>
        </div>
        <div class="card-body">
           <a href="libinsertForm.php" target="_blank" style="color: green;"> Insert Record<a/><br/><br/><br/>
           <a href="libviewForm.php" target="_blank" style="color: green;"> View Record<a/><br/><br/><br/>
           <a href="libdeleteForm.php" target="_blank" style="color: green;"> Delete Record<a/><br/><br/><br/>
           <a href="libupdateForm.php" target="_blank" style="color: green;"> Update Record<a/><br/>
        </div>
...
<footer class="footer" >
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="row">
          <div class="col-md-12 footer-copyright float-right bg-light">
