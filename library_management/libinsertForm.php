...
<div class="container">
  <div class="card-deck justify-content-center">
    <div class="col-sm-6 text-align bg-light">
       <?php
        if($status)
        {
          echo "<text style='color:green'>Record Inserted Successfully...</text>";
           ...
           else
           {
              ...
              // echo '<script>alert("Only Authorised can Insert")</script>';
...
<div class="container">
  <div class="card-deck justify-content-center">
    <div class="col-sm-6 card">
      <form action="libinsertForm.php" method="post">
        <br>
        <h1>Library Record Management</h1>
        <hr>
        <label for="sname"> <i class="fa fa-user"></i>Name Of Student :</label><br>
        <input type="text" id="cname" name="studentname" style="width: 100%" aria-pressed="false" required><br><br>
        <label for="rollnum">Roll No. of Student :</label><br>
        <input type="text" id="ccnum" name="studentrollno" style="width: 100%" aria-pressed="false" required  ><br><br>
        <label for="cnum">Class of Student :</label><br>
        <input type="text" id="ccnum" name="studentclass" style="width: 100%" aria-pressed="false" required ><br><br>
        <br>
