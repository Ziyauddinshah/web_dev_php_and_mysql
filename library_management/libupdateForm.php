...
<div class="container">
  <div class="card-deck justify-content-center">
    <div class="col-sm-10 ">
      <h1 class="text-center"> Library Record Management </h1><br>
      <form action="#" method="post">
          <table class="table" >
            ...
            <tbody style="border:none;">
               <td><?php echo $row['bid']; ?><input type="hidden" name="bookid<?php echo $i; ?>" value="<?php echo $row['bid']; ?>" /></td>
               <td><input type="text" name="studentname<?php echo $i ?>" value="<?php echo $row['studentname']; ?>" /></td>
               <td><input type="text" name="studentrollno<?php echo $i ?>" value="<?php echo $row['studentrollno']; ?>" /></td>
               <td><input type="text" name="studentclass<?php echo $i ?>" value="<?php echo $row['studentclass']; ?>" /></td>
            </tbody>
             <?php
            }
           ?>
